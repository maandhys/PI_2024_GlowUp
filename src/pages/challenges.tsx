  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center text-gray-800 font-mono">
      <header className="w-full max-w-3xl p-8 text-center text-gray-700 mt-12">
        ...
        <p className="mt-2 text-gray-500 text-lg">Participe de desafios e acompanhe o seu progresso!</p>
      </header>

      <main className="w-full max-w-3xl bg-white rounded-lg p-8 mt-6 shadow-md">
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-gray-700">Desafios Atuais</h2>
          <p className="text-gray-600">Estamos preparando novos desafios para você. Fique ligado!</p>
        </section>
      </main>
